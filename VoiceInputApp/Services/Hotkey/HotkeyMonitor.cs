...
public class HotkeyMonitor : IHotkeyMonitor
{
    ...
    private void DisableAccessibilityFeatures()
    {
        try
        {
            ...
            {
                stickyKeys.dwFlags &= ~(SKF_STICKYKEYSON | SKF_HOTKEYACTIVE | SKF_CONFIRMHOTKEY);
                SystemParametersInfo(SPI_SETSTICKYKEYS, stickyKeys.cbSize, ref stickyKeys, 0);
            }
            ...
            {
                filterKeys.dwFlags &= ~(FKF_FILTERKEYSON | FKF_HOTKEYACTIVE | FKF_CONFIRMHOTKEY);
                SystemParametersInfo(SPI_SETFILTERKEYS, filterKeys.cbSize, ref filterKeys, 0);
            }
        }
        catch
        {
